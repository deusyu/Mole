...
show_installer_help() {
    ...
    echo ""
    echo "Options:"
    echo "  --json            Output installer inventory as read-only JSON"
...
show_uninstall_help() {
    ...
    echo "  mo uninstall --list --json     Output installed app inventory as JSON"
    echo ""
    echo "Options:"
    echo "  --list            List installed apps with the exact name mo uninstall accepts"
    echo "  --json            Output --list inventory as JSON"
